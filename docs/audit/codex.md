...
- Passed: 50
- Failed: 0
- Total wall time: 0.73 sec
- Slowest observed tests:
  1) analyzer_Core: 0.47 sec
  2) config_CLI_Filtering: 0.02 sec
  3) config_CLI_Formatting: 0.02 sec
  4) config_CLI_Errors: 0.02 sec
