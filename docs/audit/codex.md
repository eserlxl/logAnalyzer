...
- Passed: 50
- Failed: 0
- Total wall time: 0.65 sec
- Slowest observed tests:
  1) analyzer_Core: 0.42 sec
  2) config_CLI_Filtering: 0.02 sec
  3) config_CLI_Analysis: 0.02 sec
  4) config_CLI_Formatting: 0.01 sec
