...
- Passed: 50
- Failed: 0
- Total wall time: 0.64 sec
- Slowest observed tests:
  1) analyzer_Core: 0.42 sec
  2) config_CLI_Filtering: 0.02 sec
  3) filter_Evaluation: 0.01 sec
  4) analyzer_LogWriter: 0.01 sec
