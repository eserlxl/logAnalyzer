...
namespace Config {
    ...
    inline const std::map<std::string, filter::FilterLogicalOperator, LogAnalyzerInternal::ci_less> FilterLogicMap = {
        {"AND", filter::FilterLogicalOperator::AND}, {"OR", filter::FilterLogicalOperator::OR}
    };

    // Case-insensitive map for SortBy strings
    inline const std::map<std::string, filter::SortBy, LogAnalyzerInternal::ci_less> SortByMap = {
    ...
    inline const std::map<std::string, filter::SortOrder, LogAnalyzerInternal::ci_less> SortOrderMap = {
    ...
    inline const std::map<std::string, ColorOption, LogAnalyzerInternal::ci_less> ColorOptionMap = {
    ...
    inline const std::map<std::string, ParserErrorAction, LogAnalyzerInternal::ci_less> ParserErrorActionMap = {
